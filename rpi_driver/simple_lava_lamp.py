...
class SimpleLavaLamp:
    ...
    def __init__(self, width: int = 32, height: int = 32):
        ...
        # 10 blobs with different animation parameters (3x larger, 2x speed)
        self.blobs = [
            {'x_speed': 0.006, 'x_range': 0.3, 'y_speed': 0.16, 'y_range': 0.4, 'radius': 0.045},
            {'x_speed': 0.012, 'x_range': 0.1, 'y_speed': 0.14, 'y_range': 0.5, 'radius': 0.042},
            {'x_speed': 0.016, 'x_range': 0.3, 'y_speed': 0.06, 'y_range': 0.5, 'radius': 0.048},
            {'x_speed': 0.012, 'x_range': 0.2, 'y_speed': 0.12, 'y_range': 0.5, 'radius': 0.048},
            {'x_speed': 0.018, 'x_range': 0.3, 'y_speed': 0.16, 'y_range': 0.4, 'radius': 0.045},
            {'x_speed': 0.018, 'x_range': 0.1, 'y_speed': 0.10, 'y_range': 0.5, 'radius': 0.048},
            {'x_speed': 0.006, 'x_range': 0.3, 'y_speed': 0.06, 'y_range': 0.5, 'radius': 0.051},
            {'x_speed': 0.012, 'x_range': 0.2, 'y_speed': 0.08, 'y_range': 0.5, 'radius': 0.042},
            {'x_speed': 0.014, 'x_range': 0.3, 'y_speed': 0.14, 'y_range': 0.5, 'radius': 0.045},
            {'x_speed': 0.018, 'x_range': 0.1, 'y_speed': 0.20, 'y_range': 0.5, 'radius': 0.045},
        ]
